...
async def create_category(category: CategoryCreate, admin_user: dict = Depends(verify_admin)):
...
async def delete_category(category_id: str, admin_user: dict = Depends(verify_admin)):
    db = await get_database()
